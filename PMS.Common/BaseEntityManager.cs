...
namespace PMS.Common
{
    ...
    {
        private static PMSContext _dbContext;
        public bool SaveChangesSuccess { get; protected set; }
        private static ILogger logger;

        public PMSContext CurrentContext
        {
            get
            {
                if (_dbContext == null)
        ...
        /// </summary>
        public BaseEntityManager(PMSContext dbContext)
        {
            if (dbContext != null)
            ...
            else
            {
                ...
                new ExceptionLogger(logger).SaveToLog(message);
        ...
        {
            _dbContext.Database.Log = new ExceptionLogger(logger).SaveSQLsToLog;
            ...
            //logger = container.Resolve<EventLogger>();
            //if (!logger.ifExists())
            logger = container.Resolve<FileLogger>();

            new ExceptionLogger(logger).SaveToLog("Testing logger");
        }
        ...
        public virtual IQueryable<EntityType> GetAll(string navigationalProperties = "")
        {
            ...
            {
                _retData=null;
                new ExceptionLogger(logger).LogException(ex, EntityName(), "GetAll");
            }
        ...
        public EntityType GetById(Guid id, string navigationalProperties = "")
        {
            ...
            {
                entity = null;
                new ExceptionLogger(logger).LogException(ex, EntityName(), "GetById");
            }
            return entity;
        }
        ...
        public int SaveChanges()
        {
            ...
            catch (Exception ex)
            {
                ...
                retValue = 0;
                new ExceptionLogger(logger).LogException(ex, EntityName(), "SaveChanges");
            }
            return retValue;
        }
